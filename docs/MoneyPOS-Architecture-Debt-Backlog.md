...
| AD-2.57 | UMS 会员 Entity 物理归属迁移 | 待实施 | 将 `UmsMember` 迁入 UMS 持久化边界，更新同域 Mapper、档案、导入、资产、日志、充值、查询、Controller 和测试。 | 保持会员管理/资产/结账/退款/POS/排行/FIN-HOME、表/Flyway 与事务；预期登记册降至 1，桥保持 0。 |
