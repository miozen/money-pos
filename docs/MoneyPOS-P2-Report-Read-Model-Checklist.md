...
- [ ] P2.4.1 迁移 FIN 风控审计快照：TRADE 提供收银员风险汇总与异常订单快照，FIN 保留日期解析和卡片聚合。
- [ ] P2.4.2～P2.4.5 迁移交接班、利润/营销、经营分析与瀑布流：分别收敛为 TRADE/GMS/UMS/SYS 所有者查询；不把不同财务口径强行合并。
...
**P2.4.1：迁移 FIN 风控的 TRADE 审计快照，保留既有日期边界、状态规则、风险谓词与页面字段。**
