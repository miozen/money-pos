...
public class GmsBrand extends BaseEntity {
    @Schema(description = "品牌logo") private String logo;
    @Schema(description = "品牌名称") private String name;
    @Schema(description = "品牌描述") private String description;
    @Schema(description = "商品数量") private Integer goodsCount;
